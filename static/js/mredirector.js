...
class CheckRuntime {
  ...
  isMobile() {
    return this.info.detectOS === 'iOS' || this.info.detectOS === 'Android OS' || this.info.detectOS === 'Windows Mobile' || this.info.detectOS === 'BlackBerry OS'
  }
...
var BasChain = new CheckRuntime(navigator.userAgent)

console.log(">>>>", BasChain.isMobile())
if (BasChain.isMobile()){
  window.location.replace("https://mbaschain.github.io")
}
